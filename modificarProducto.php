            ...
            <center>
                ...
                <table width="690" border="1" align="center" cellpadding="2" cellspacing="1">
                    <tr>
                        ...
                        <td width="139" align="center" valign="middle"><div align="center">Cantidad: </div></td>
                        ...
                        while ($row=mysqli_fetch_assoc($resultado)) { ?>
                            <tr align="center">
                                ...
                                <td>
                                    ...
                                    <a href="eliminarproducto.php?id=<?php echo $row["idProducto"]; ?>" class="table_item_link_eliminar">Eliminar</a>
                                </td>
                            </tr>
